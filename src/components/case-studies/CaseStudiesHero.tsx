      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        >
          <div className="inline-flex items-center space-x-2 glass px-4 py-2 rounded-full mb-8">
            ...
            <span className="text-xs uppercase tracking-widest text-[#E2FF3B] font-bold">Our Work</span>
          </div>
          
          <h1 className="text-6xl md:text-8xl font-bold mb-8 uppercase leading-[1.1]">
            High-Performance <br />
            <span className="text-[#555555]">Experiences.</span>
          </h1>
          
          <p className="text-lg md:text-xl text-[#999999] max-w-2xl leading-relaxed">
            A selection of strategic partnerships and success stories where we've helped founders scale through design and innovation.
          </p>
        </motion.div>
      </div>
